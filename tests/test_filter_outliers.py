...
def test_filter_outliers_removes_negative_zero_and_extreme_values() -> None:
    df = pd.DataFrame(
        {
            "InvoiceNo": ["1001", "1002", "1003", "1004"],
            "StockCode": ["A", "B", "C", "D"],
            "Description": ["Lamp", "Mug", "Tray", "Chair"],
            "Quantity": [1, 0, -3, 20_000],
    ...
    result = cleaner.filter_outliers()

    assert result["InvoiceNo"].tolist() == ["1001"]